...
class AuthGroupModel extends \Think\Model
{
	...
	protected $_validate = array(
		array('title', 'require', '必须设置用户组标题', Think\Model::MUST_VALIDATE, 'regex', Think\Model::MODEL_INSERT),
		array('description', '0,80', '描述最多80字符', Think\Model::VALUE_VALIDATE, 'length', Think\Model::MODEL_BOTH)
		);
